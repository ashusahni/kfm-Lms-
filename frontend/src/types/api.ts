...
export interface AppConfig {
  ...
  showOtherRegisterMethod?: boolean;
...
export interface WebinarBrief {
  ...
  /** 7_days | 30_days for challenge courses */
...
/**
 * Login request – use either username (email) or mobile + country_code
 */
...
/** Student recipe assignment – one recommended meal assigned by dietician. */
export interface RecommendedMealAssignment {
