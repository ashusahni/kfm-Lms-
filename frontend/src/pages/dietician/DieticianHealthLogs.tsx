...
export default function DieticianHealthLogs() {
  ...
  const { data: summaryData } = useQuery({
    queryKey: ["dietician-health-logs-summary", from, to, courseFilter],
    queryFn: () =>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Monitor health logs for students enrolled in your assigned programs (read-only).
            </p>
          </div>
        </div>
                    ...
                    {logs.map((log) => (
                      ...
                      >
                        ...
                        <td className="py-3 px-4">
                          <Link
                            to={`/dietician/students/${log.user_id}/health-profile`}
