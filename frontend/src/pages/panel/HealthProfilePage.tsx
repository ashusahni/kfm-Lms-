...
export default function HealthProfilePage() {
  const { data, isLoading, error } = useQuery({
    ...
    queryFn: () => onboardingApi.getProfileData(),
  });
        ...
        <Card className="border-destructive/50 bg-destructive/5">
          <CardContent className="py-6">
            <p className="text-muted-foreground">
              Could not load your health profile. You can complete the questionnaire again from the
              onboarding flow.
            </p>
          </CardContent>
        </Card>
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Details you shared during signup. This helps your coaches personalize your program.
        </p>
      </div>
