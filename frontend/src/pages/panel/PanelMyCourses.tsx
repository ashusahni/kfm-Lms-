...
export default function PanelMyCourses() {
      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="mt-2 text-muted-foreground">
            Manage batches for courses you teach.
          </p>
        </div>
        <Card className="border border-border overflow-hidden">
          <div className="bg-muted/50 px-6 py-16 text-center">
            ...
            <p className="mt-4 text-muted-foreground font-medium">
              Only dieticians can manage program batches.
            </p>
            <p className="mt-1 text-sm text-muted-foreground">
              If you run programs, make sure your account has dietician access. Use the Dietician dashboard to manage batches.
            </p>
            <Link to="/panel">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-muted-foreground">
              Select a course to create and manage batches (cohorts).
            </p>
          </div>
        </div>
      </motion.div>
      ...
      {!isLoading && list.length === 0 && (
        <Card className="border border-border overflow-hidden">
          <div className="bg-muted/30 px-6 py-16 text-center">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              You don’t have any teaching courses. Create one from the admin panel or wait for an assignment.
            </p>
            <Link to="/panel">
              <Button variant="outline" className="mt-6">
                Back to dashboard
      ...
      {!isLoading && list.length > 0 && (
        ...
        >
          {list.map((course, i) => (
            ...
            >
              <Link
                  to={`/panel/my-courses/${course.id}/batches`}
