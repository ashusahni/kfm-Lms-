                                ...
                                <table class="table table-striped font-14 ">
                                    ...
                                    @foreach($webinars as $webinar)
                                        <tr class="text-center">
                                            ...
                                            <td class="text-left">{{ $webinar->teacher ? $webinar->teacher->full_name : trans('admin/main.unknown') }}</td>
                                                ...
                                                <div class="btn-group dropdown table-actions">
                                                    ...
                                                    <div class="dropdown-menu text-left webinars-lists-dropdown">
                                                        ...
                                                        @can('admin_webinars_list')
                                                            <a href="{{ getAdminPanelUrl() }}/webinars/{{ $webinar->id }}/batches" target="_blank" class="d-flex align-items-center text-dark text-decoration-none btn-transparent btn-sm text-primary mt-1 " title="{{ trans('admin/main.course_batches') ?? 'Batches' }}">
                                                                <i class="fa fa-layer-group"></i>
                                                                <span class="ml-2">{{ trans('admin/main.course_batches') ?? 'Batches' }}</span>
                                                            </a>
                                                        @endcan
