                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-pills" id="myTab3" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link @if(request()->get('tab') == "payment_channels") active @endif" id="payment_channels-tab" href="{{ getAdminPanelUrl() }}/settings/financial?tab=payment_channels" role="tab" aria-controls="payment_channels">{{ trans('admin/main.payment_channels') }} (Razorpay)</a>
                                </li>
