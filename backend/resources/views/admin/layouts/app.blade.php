...
<body class="@if($isRtl) rtl @endif" data-lfm-prefix="{{ getAdminPanelUrl('/laravel-filemanager') }}">
...
<script>window.LARAVEL_FILEMANAGER_PREFIX = {{ json_encode(getAdminPanelUrl('/laravel-filemanager')) }};</script>
<!-- Template JS File -->
...
{{-- Fix file manager 404: open /admin/laravel-filemanager (inline so it works even if custom.js is cached) --}}
<script>
(function() {
    var prefix = {{ json_encode(getAdminPanelUrl('/laravel-filemanager')) }};
