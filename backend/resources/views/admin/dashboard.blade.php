    ...
    <section class="section">
        <div class="row">
            <div class="col-12 mb-4">
                <div class="hero text-white hero-bg-image hero-bg admin-dashboard-hero" data-background="{{ !empty(getPageBackgroundSettings('admin_dashboard')) ? getPageBackgroundSettings('admin_dashboard') : '' }}">
                    <div class="hero-inner">
                        <h2 class="admin-welcome-title">{{ trans('admin/main.welcome') }}, {{ $authUser->full_name }}!</h2>
                            ...
                            @can('admin_general_dashboard_quick_access_links')
                                <div>
                                    ...
                                    <div class="mt-2 mb-2 d-flex flex-wrap gap-2">
                                        <a href="{{ getAdminPanelUrl() }}/comments/webinars" class="mt-2 mt-md-0 btn btn-outline-white btn-lg btn-icon icon-left ml-0 ml-md-2 admin-quick-link"><i class="far fa-comment"></i> {{ trans('admin/main.comments') }}</a>
                                        <a href="{{ getAdminPanelUrl() }}/supports" class="mt-2 mt-md-0 btn btn-outline-white btn-lg btn-icon icon-left ml-0 ml-md-2 admin-quick-link"><i class="far fa-envelope"></i> {{ trans('admin/main.tickets') }}</a>
                                        <a href="{{ getAdminPanelUrl() }}/reports/webinars" class="mt-2 mt-md-0 btn btn-outline-white btn-lg btn-icon icon-left ml-0 ml-md-2 admin-quick-link"><i class="fas fa-info-circle"></i> {{ trans('admin/main.reports') }}</a>
                                    </div>
                                </div>
                            @endcan
        ...
        <div class="row">
            ...
            @can('admin_general_dashboard_new_reviews')
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <a href="{{ getAdminPanelUrl() }}/reviews" class="card card-statistic-1">
                                    ...
                                    @foreach($recentTickets['tickets'] as $ticket)
                                        <a href="{{ getAdminPanelUrl() }}/supports/{{ $ticket->id }}/conversation" class="ticket-item">
                                            ...
                                            <div class="ticket-info">
                                                <div>{{ $ticket->user ? $ticket->user->full_name : trans('admin/main.unknown') }}</div>
                                ...
                                <div class="tickets-list">
                                    @foreach($recentWebinars['webinars'] as $webinar)
                                        <a href="{{ getAdminPanelUrl() }}/webinars/{{ $webinar->id }}/edit" class="ticket-item">
                                            ...
                                            <div class="ticket-info">
                                                <div>{{ $webinar->teacher ? $webinar->teacher->full_name : trans('admin/main.unknown') }}</div>
                                                <div class="bullet"></div>
                                ...
                                <div class="tickets-list">
                                    ...
                                    @foreach($recentCourses['courses'] as $course)
                                        <a href="{{ getAdminPanelUrl() }}/webinars/{{ $course->id }}/edit" class="ticket-item">
                                            ...
                                            <div class="ticket-info">
                                                <div>{{ $course->teacher ? $course->teacher->full_name : trans('admin/main.unknown') }}</div>
                                                <div class="bullet"></div>
