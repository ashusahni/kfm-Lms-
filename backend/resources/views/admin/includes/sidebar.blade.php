<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
                ...
                <li class="nav-item dropdown {{ (request()->is(getAdminPanelUrl('/webinars*', false)) and !request()->is(getAdminPanelUrl('/webinars/comments*', false))) ? 'active' : '' }}">
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_webinars_list')
                            ...
                            <li class="{{ request()->is(getAdminPanelUrl('/batches', false)) ? 'active' : '' }}">
                                <a class="nav-link" href="{{ getAdminPanelUrl() }}/batches">{{ trans('admin/main.course_batches') ?? 'Course batches' }}</a>
                            </li>
                        @endcan()
            ...
            @can('admin_users')
                <li class="nav-item dropdown {{ (request()->is(getAdminPanelUrl('/students', false)) or request()->is(getAdminPanelUrl('/dieticians', false))) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('admin_instructors_list')
                            <li class="{{ (request()->is(getAdminPanelUrl('/dieticians', false))) ? 'active' : '' }}">
                                <a class="nav-link" href="{{ getAdminPanelUrl() }}/dieticians">{{ trans('admin/main.dietitians') }}</a>
                            </li>
                        @endcan()
            ...
            @can('admin_become_instructors_list')
                <li class="nav-item dropdown {{ (request()->is(getAdminPanelUrl('/users/become-dieticians*', false))) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                        <i class="fas fa-list-alt"></i>
                        <span>{{ trans('admin/main.dietitian_requests') }}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <li class="{{ (request()->is(getAdminPanelUrl('/users/become-dieticians/instructors', false))) ? 'active' : '' }}">
                            <a class="nav-link" href="{{ getAdminPanelUrl() }}/users/become-dieticians/instructors">
                                <span>{{ trans('admin/main.pending_dietitian_requests') ?? 'Pending (Dietitians)' }}</span>
                            </a>
                        </li>

                        <li class="{{ (request()->is(getAdminPanelUrl('/users/become-dieticians/organizations', false))) ? 'active' : '' }}">
                            <a class="nav-link" href="{{ getAdminPanelUrl() }}/users/become-dieticians/organizations">
            ...
            @can('admin_general_dashboard_show')
                <li class="{{ (request()->is(getAdminPanelUrl('/health-log*', false)) and !request()->is(getAdminPanelUrl('/course-health-log-settings*', false)) and !request()->is(getAdminPanelUrl('/student-health-logs*', false)) and !request()->is(getAdminPanelUrl('/system-health*', false))) ? 'active' : '' }}">
                ...
                <li class="{{ (request()->is(getAdminPanelUrl('/student-health-logs*', false)) or (request()->is(getAdminPanelUrl('/health-log*', false)) and !request()->is(getAdminPanelUrl('/course-health-log-settings*', false)) and !request()->is(getAdminPanelUrl('/system-health*', false)))) ? 'active' : '' }}">
                    <a href="{{ getAdminPanelUrl() }}/health-log" class="nav-link">
                        <i class="fas fa-clipboard-list"></i>
                        <span>{{ trans('admin/main.student_health_logs') ?? 'Student health logs' }}</span>
                    </a>
                </li>
                <li class="{{ (request()->is(getAdminPanelUrl('/system-health*', false))) ? 'active' : '' }}">
                    <a href="{{ getAdminPanelUrl() }}/system-health" class="nav-link">
                        <i class="fas fa-server"></i>
                        <span>{{ trans('admin/main.system_health') ?? 'System health' }}</span>
                    </a>
                </li>
            @endcan
