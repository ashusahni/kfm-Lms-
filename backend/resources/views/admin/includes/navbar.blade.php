...
<nav class="navbar navbar-expand-lg main-navbar">
    ...
    <form class="form-inline mr-auto flex-grow-1 admin-navbar-search-wrap">
        <ul class="navbar-nav mr-3">
            <li><a href="#" data-toggle="sidebar" class="nav-link nav-link-lg" title="{{ trans('admin/main.dashboard') }}"><i class="fas fa-bars"></i></a></li>
        ...
        <div class="admin-global-search d-none d-md-flex align-items-center ml-3">
            ...
            <input type="text" class="admin-search-input" placeholder="{{ trans('admin/main.search_placeholder') ?? 'Search courses, users, sales...' }}" id="adminGlobalSearch" autocomplete="off">
