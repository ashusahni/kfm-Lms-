...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ trans('admin/main.dietitians') }}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="#">{{ trans('admin/main.dietitians') }}</a></div>
        ...
        <div class="row">
                ...
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4>{{ trans('admin/main.total_dietitians') }}</h4>
                        </div>
                        <div class="card-body">
                            {{ $totalInstructors }}
                        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4>{{ trans('admin/main.inactive_dietitians') }}</h4>
                        </div>
                        <div class="card-body">
                            {{ $inactiveInstructors }}
                        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4>{{ trans('admin/main.ban_dietitians') }}</h4>
                        </div>
                        <div class="card-body">
                            {{ $banInstructors }}
                        </div>
    ...
    <div class="card">
        <div class="card-header">
            @can('admin_users_export_excel')
                <a href="{{ getAdminPanelUrl() }}/dieticians/excel?{{ http_build_query(request()->all()) }}" class="btn btn-primary">{{ trans('admin/main.export_xls') }}</a>
            @endcan
            <div class="h-10"></div>
        </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center mb-2" width="120">
                                ...
                                @can('admin_instructors_list')
                                    <a href="{{ getAdminPanelUrl() }}/dieticians/{{ $user->id }}/assign-courses" class="btn-transparent text-info" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.assign_courses') ?? 'Assign courses' }}">
