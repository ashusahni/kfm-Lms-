                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            ...
                            <div class="form-group js-file-path-input {{ (!empty($file) and $file->storage == 's3') ? 'd-none' : '' }}">
                                ...
                                <small class="form-text text-muted">{{ trans('update.file_source_upload_placeholder') }}</small>
                            </div>

                            <div class="form-group js-local-upload-file-input {{ (!empty($file) and $file->storage == 'upload') ? '' : 'd-none' }}">
                                <label class="input-label">{{ trans('update.upload_from_device') }}</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text text-white"><i data-feather="hard-drive" width="18" height="18" class="text-white"></i></span>
                                    </div>
                                    <div class="custom-file">
                                        <input type="file" name="local_file" class="js-local-upload-file js-ajax-local_file custom-file-input cursor-pointer" id="localFile{{ !empty($file) ? $file->id : 'record' }}">
                                        <label class="custom-file-label cursor-pointer" for="localFile{{ !empty($file) ? $file->id : 'record' }}">{{ trans('update.choose_file') }}</label>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
                                <small class="form-text text-muted">{{ trans('update.upload_from_device_hint') }}</small>
                            </div>
