...
var lfm = function (options, cb) {
    var defaultPrefix = getLfmPrefix();
    var route_prefix = (options && options.prefix) ? options.prefix : defaultPrefix;
...
var LFMButton = function (context) {
    ...
    var button = ui.button({
        ...
        click: function () {
            ...
            lfm({type: 'file', prefix: prefix}, function (lfmItems, path) {
