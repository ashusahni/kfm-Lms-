            ...
            <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="card card-large-icons">
                            ...
                            <div class="card-body">
                                <h4>Payment gateways (Razorpay)</h4>
                                <p>Manage Razorpay checkout: enable/disable, set title and logo. Configure keys in .env (RAZORPAY_API_KEY, RAZORPAY_API_SECRET).</p>
                                <a href="<?php echo e(getAdminPanelUrl()); ?>/settings/financial?tab=payment_channels" class="card-cta">Open Razorpay settings<i class="fas fa-chevron-right"></i></a>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ashut\Downloads\Telegram Desktop\rocket-lms_v1.8\backend\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>