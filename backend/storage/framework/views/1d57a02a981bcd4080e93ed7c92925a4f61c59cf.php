...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group mt-15 ">
                                                <label class="input-label d-block"><?php echo e(trans('admin/main.challenge_course') ?? 'Challenge course'); ?></label>
                                                <select name="challenge_type" class="custom-select <?php $__errorArgs = ['challenge_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                                    <option value="" <?php if(empty($webinar->challenge_type) && old('challenge_type') !== '7_days' && old('challenge_type') !== '30_days'): ?> selected <?php endif; ?>><?php echo e(trans('admin/main.no_challenge') ?? 'No (regular course)'); ?></option>
                                                    <option value="7_days" <?php if((!empty($webinar) && $webinar->challenge_type === '7_days') || old('challenge_type') === '7_days'): ?> selected <?php endif; ?>>7 Day Challenge</option>
                                                    <option value="30_days" <?php if((!empty($webinar) && $webinar->challenge_type === '30_days') || old('challenge_type') === '30_days'): ?> selected <?php endif; ?>>30 Day Challenge</option>
                                                </select>
                                                <small class="text-muted"><?php echo e(trans('admin/main.challenge_course_hint') ?? 'Course is released in batches by start date. When a customer purchases, they join the selected batch (e.g. Batch starting 1 Mar). Add batches under Course batches.'); ?></small>
                                                <?php $__errorArgs = ['challenge_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group mt-15 ">
                                                <label class="input-label d-block">Program domain (health / fitness)</label>
                                                <select name="program_domain" class="custom-select <?php $__errorArgs = ['program_domain'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                                    <option value="general" <?php if((!empty($webinar) && ($webinar->program_domain ?? 'general') === 'general') || old('program_domain', 'general') === 'general'): ?> selected <?php endif; ?>>General</option>
                                                    <option value="health" <?php if((!empty($webinar) && ($webinar->program_domain ?? '') === 'health') || old('program_domain') === 'health'): ?> selected <?php endif; ?>>Health</option>
                                                    <option value="fitness" <?php if((!empty($webinar) && ($webinar->program_domain ?? '') === 'fitness') || old('program_domain') === 'fitness'): ?> selected <?php endif; ?>>Fitness</option>
                                                    <option value="nutrition" <?php if((!empty($webinar) && ($webinar->program_domain ?? '') === 'nutrition') || old('program_domain') === 'nutrition'): ?> selected <?php endif; ?>>Nutrition</option>
                                                    <option value="wellness" <?php if((!empty($webinar) && ($webinar->program_domain ?? '') === 'wellness') || old('program_domain') === 'wellness'): ?> selected <?php endif; ?>>Wellness</option>
                                                </select>
                                                <small class="text-muted">For health, fitness, nutrition or wellness: enables intake form and health log settings for this course.</small>
                                                <?php $__errorArgs = ['program_domain'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <?php if(!empty($webinar) and $webinar->creator and $webinar->creator->isOrganization()): ?>
                                                <div class="form-group mt-15 ">
                                            ...
                                            <div class="form-group mt-15">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <button type="button" class="input-group-text admin-file-manager" data-input="thumbnail" data-preview="holder" data-prefix="<?php echo e(getAdminPanelUrl('/laravel-filemanager')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group mt-15">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <button type="button" class="input-group-text admin-file-manager" data-input="cover_image" data-preview="holder" data-prefix="<?php echo e(getAdminPanelUrl('/laravel-filemanager')); ?>">
                                                            <i class="fa fa-upload"></i>
                                                        </button>
                                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group mt-0">
                                                ...
                                                <div class="input-group js-video-demo-path-input">
                                                    <div class="input-group-prepend">
                                                        <button type="button" class="js-video-demo-path-upload input-group-text admin-file-manager <?php echo e((empty($webinar) or empty($webinar->video_demo_source) or $webinar->video_demo_source == 'upload') ? '' : 'd-none'); ?>" data-input="demo_video" data-preview="holder" data-prefix="<?php echo e(getAdminPanelUrl('/laravel-filemanager')); ?>">
                                                            <i class="fa fa-upload"></i>
                                                        </button>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group mt-15">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" name="sequential_module_unlock" value="1" class="custom-control-input" id="sequential_module_unlock" <?php if(!empty($webinar) && $webinar->sequential_module_unlock): ?> checked <?php endif; ?> <?php if(old('sequential_module_unlock')): ?> checked <?php endif; ?>>
                                                    <label class="custom-control-label" for="sequential_module_unlock"><?php echo e(trans('update.sequential_module_unlock') ?? 'Unlock content week by week'); ?></label>
                                                </div>
                                                <p class="text-muted small mt-1"><?php echo e(trans('update.sequential_module_unlock_hint') ?? 'When enabled, students can only access the first chapter (week/module). After completing all items in it, the next chapter unlocks.'); ?></p>
                                            </div>
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group mt-30">
                                                <label class="input-label d-block"><?php echo e(trans('admin/main.assigned_dietitians') ?? 'Assigned dietitians'); ?></label>
                                                <select name="dietician_ids[]" multiple class="form-control select2" data-placeholder="<?php echo e(trans('admin/main.select_dietitians_to_manage_course') ?? 'Select dietitians who can manage this course'); ?>">
                                                    <?php if(!empty($dietitians)): ?>
                                                        <?php $__currentLoopData = $dietitians; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($d->id); ?>" <?php echo e(in_array($d->id, $assignedDieticianIds ?? []) ? 'selected' : ''); ?>><?php echo e($d->full_name); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <?php endif; ?>
                                                </select>
                                                <div class="text-muted text-small mt-1"><?php echo e(trans('admin/main.assigned_dietitians_hint') ?? 'Assigned dietitians can manage batches and view client health logs for this course.'); ?></div>
                                            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ashut\Downloads\Telegram Desktop\rocket-lms_v1.8 (2)\backend\resources\views/admin/webinars/create.blade.php ENDPATH**/ ?>