    ...
    <section class="section">
        <div class="row">
            <div class="col-12 mb-4">
                <div class="hero text-white hero-bg-image hero-bg admin-dashboard-hero" data-background="<?php echo e(!empty(getPageBackgroundSettings('admin_dashboard')) ? getPageBackgroundSettings('admin_dashboard') : ''); ?>">
                    <div class="hero-inner">
                        <h2 class="admin-welcome-title"><?php echo e(trans('admin/main.welcome')); ?>, <?php echo e($authUser->full_name); ?>!</h2>
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_general_dashboard_quick_access_links')): ?>
                                <div>
                                    ...
                                    <div class="mt-2 mb-2 d-flex flex-wrap gap-2">
                                        <a href="<?php echo e(getAdminPanelUrl()); ?>/comments/webinars" class="mt-2 mt-md-0 btn btn-outline-white btn-lg btn-icon icon-left ml-0 ml-md-2 admin-quick-link"><i class="far fa-comment"></i> <?php echo e(trans('admin/main.comments')); ?></a>
                                        <a href="<?php echo e(getAdminPanelUrl()); ?>/supports" class="mt-2 mt-md-0 btn btn-outline-white btn-lg btn-icon icon-left ml-0 ml-md-2 admin-quick-link"><i class="far fa-envelope"></i> <?php echo e(trans('admin/main.tickets')); ?></a>
                                        <a href="<?php echo e(getAdminPanelUrl()); ?>/reports/webinars" class="mt-2 mt-md-0 btn btn-outline-white btn-lg btn-icon icon-left ml-0 ml-md-2 admin-quick-link"><i class="fas fa-info-circle"></i> <?php echo e(trans('admin/main.reports')); ?></a>
                                    </div>
                                </div>
                            <?php endif; ?>
        ...
        <div class="row">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_general_dashboard_new_reviews')): ?>
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <a href="<?php echo e(getAdminPanelUrl()); ?>/reviews" class="card card-statistic-1">
                                    ...
                                    <?php $__currentLoopData = $recentTickets['tickets']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e(getAdminPanelUrl()); ?>/supports/<?php echo e($ticket->id); ?>/conversation" class="ticket-item">
                                            ...
                                            <div class="ticket-info">
                                                <div><?php echo e($ticket->user ? $ticket->user->full_name : trans('admin/main.unknown')); ?></div>
                                ...
                                <div class="tickets-list">
                                    <?php $__currentLoopData = $recentWebinars['webinars']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $webinar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e(getAdminPanelUrl()); ?>/webinars/<?php echo e($webinar->id); ?>/edit" class="ticket-item">
                                            ...
                                            <div class="ticket-info">
                                                <div><?php echo e($webinar->teacher ? $webinar->teacher->full_name : trans('admin/main.unknown')); ?></div>
                                                <div class="bullet"></div>
                                ...
                                <div class="tickets-list">
                                    ...
                                    <?php $__currentLoopData = $recentCourses['courses']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e(getAdminPanelUrl()); ?>/webinars/<?php echo e($course->id); ?>/edit" class="ticket-item">
                                            ...
                                            <div class="ticket-info">
                                                <div><?php echo e($course->teacher ? $course->teacher->full_name : trans('admin/main.unknown')); ?></div>
                                                <div class="bullet"></div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ashut\Downloads\Telegram Desktop\rocket-lms_v1.8 (2)\backend\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>