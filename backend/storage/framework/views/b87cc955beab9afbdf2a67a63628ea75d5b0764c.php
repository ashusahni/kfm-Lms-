...
<?php else: ?>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            ...
                            <div class="form-group js-file-path-input <?php echo e((!empty($file) and $file->storage == 's3') ? 'd-none' : ''); ?>">
                                ...
                                <small class="form-text text-muted"><?php echo e(trans('update.file_source_upload_placeholder')); ?></small>
                            </div>

                            <div class="form-group js-local-upload-file-input <?php echo e((!empty($file) and $file->storage == 'upload') ? '' : 'd-none'); ?>">
                                <label class="input-label"><?php echo e(trans('update.upload_from_device')); ?></label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i data-feather="hard-drive" width="18" height="18"></i></span>
                                    </div>
                                    <div class="custom-file">
                                        <input type="file" name="local_file" class="js-local-upload-file js-ajax-local_file custom-file-input cursor-pointer" id="localFile<?php echo e(!empty($file) ? $file->id : 'record'); ?>">
                                        <label class="custom-file-label cursor-pointer" for="localFile<?php echo e(!empty($file) ? $file->id : 'record'); ?>"><?php echo e(trans('update.choose_file')); ?></label>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
                                <small class="form-text text-muted"><?php echo e(trans('update.upload_from_device_hint')); ?></small>
                            </div>
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php /**PATH C:\Users\ashut\Downloads\Telegram Desktop\rocket-lms_v1.8 (2)\backend\resources\views/admin/webinars/create_includes/accordions/file.blade.php ENDPATH**/ ?>