...
<nav class="navbar navbar-expand-lg main-navbar">
    ...
    <form class="form-inline mr-auto flex-grow-1 admin-navbar-search-wrap">
        <ul class="navbar-nav mr-3">
            <li><a href="#" data-toggle="sidebar" class="nav-link nav-link-lg" title="<?php echo e(trans('admin/main.dashboard')); ?>"><i class="fas fa-bars"></i></a></li>
            <li><a href="#" data-toggle="search" class="nav-link nav-link-lg d-sm-none"><i class="fas fa-search"></i></a></li>
        </ul>
        <div class="admin-global-search d-none d-md-flex align-items-center ml-3">
            <i class="fas fa-search text-white-50 mr-2"></i>
            <input type="text" class="admin-search-input" placeholder="<?php echo e(trans('admin/main.search_placeholder') ?? 'Search courses, users, sales...'); ?>" id="adminGlobalSearch" autocomplete="off">
            <kbd class="admin-search-kbd ml-2 d-none d-lg-inline">Ctrl+K</kbd>
        </div>
    </form>
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                ...
                <i class="fas fa-chevron-down ml-1 d-none d-lg-inline-block" style="font-size: 10px; opacity: 0.8;"></i>
            </a>
            <div class="dropdown-menu dropdown-menu-right admin-user-dropdown">
...
<?php /**PATH C:\Users\ashut\Downloads\Telegram Desktop\rocket-lms_v1.8\Source\Source\resources\views/admin/includes/navbar.blade.php ENDPATH**/ ?>