...
Route::group(['namespace' => 'Panel', 'prefix' => 'panel', 'middleware' => ['check_mobile_app', 'impersonate', 'panel', 'share', 'check_maintenance']], function () {
    ...
    Route::group(['prefix' => 'webinars'], function () {
        Route::group(['middleware' => 'user.not.access'], function () {
            ...
            Route::group(['prefix' => '{webinar_id}/batches'], function () {
                Route::get('/', 'CourseBatchController@index');
                Route::get('/create', 'CourseBatchController@create');
                Route::post('/', 'CourseBatchController@store');
                Route::get('/{batch_id}/edit', 'CourseBatchController@edit');
                Route::post('/{batch_id}', 'CourseBatchController@update');
                Route::get('/{batch_id}/delete', 'CourseBatchController@destroy');
            });
        });
