...
Route::group(['prefix' => $prefix, 'namespace' => 'Admin', 'middleware' => ['web', 'admin_locale']], function () use ($prefix) {
    ...
    Route::group(['middleware' => 'admin'], function () {
        ...
        // Laravel File Manager (thumbnails, cover images, videos) - under admin so same origin/proxy
        ...
        Route::group(['prefix' => 'course-health-log-settings'], function () {
            Route::get('/', 'CourseHealthLogSettingController@index');
            Route::get('/{webinar_id}/edit', 'CourseHealthLogSettingController@edit');
            Route::post('/{webinar_id}', 'CourseHealthLogSettingController@update');
        });
        ...
        Route::group(['prefix' => 'dieticians'], function () {
            Route::get('/', 'UserController@instructors');
            Route::get('/excel', 'UserController@exportExcelInstructors');
            Route::get('/{id}/assign-courses', 'UserController@assignCourses');
            Route::post('/{id}/assign-courses', 'UserController@postAssignCourses');
        });
        ...
        Route::group(['prefix' => 'users'], function () {
            ...
            Route::group(['prefix' => 'become-dieticians'], function () {
        ...
        Route::get('batches', 'CourseBatchController@batchesIndex');
        ...
        Route::group(['prefix' => 'webinars'], function () {
            ...
            Route::get('/{id}/batches', 'CourseBatchController@index');
            Route::get('/{id}/batches/create', 'CourseBatchController@create');
            Route::post('/{id}/batches', 'CourseBatchController@store');
            Route::get('/{id}/batches/{batch_id}/edit', 'CourseBatchController@edit');
            Route::post('/{id}/batches/{batch_id}', 'CourseBatchController@update');
            Route::get('/{id}/batches/{batch_id}/delete', 'CourseBatchController@destroy');
