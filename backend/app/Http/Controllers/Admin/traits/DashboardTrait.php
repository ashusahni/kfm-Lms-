...
trait DashboardTrait
{
    ...
    public function getRecentComments()
    {
        ...
        return Comment::whereNotNull('user_id')
            ->with('user')
    ...
    public function getRecentTickets()
    {
        ...
        $tickets = Support::whereNotNull('department_id')
            ->whereNotNull('user_id')  // Only show tickets with valid users
    ...
    public function getRecentWebinars()
    {
        ...
        $webinars = Webinar::where('type', Webinar::$webinar)
            ->whereNotNull('teacher_id')  // Only show webinars with valid teachers
            ->with('teacher')  // Eager load teacher relationship
            ->orderBy('created_at', 'desc')
            ->limit(5)
            ->get();
    ...
    public function getRecentCourses()
    {
        ...
        $courses = Webinar::where('type', Webinar::$course)
            ->whereNotNull('teacher_id')  // Only show courses with valid teachers
            ->with('teacher')  // Eager load teacher relationship
            ->orderBy('created_at', 'desc')
            ->limit(5)
            ->get();
