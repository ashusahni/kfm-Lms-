...
class Webinar extends Model
{
    ...
    public function getBriefAttribute()
    {
        ...
        return [
            ...
            'learning_url' => $this->getLearningPageUrl(),
            ...
            'challenge_type' => $this->challenge_type ?? null,
            'challenge_duration_days' => $this->getChallengeDurationDays(),
    ...
    public function getDetailsAttribute()
    {
        ...
        $details = [
            ...
            'batches' => $this->batches()->orderBy('sort_order')->orderBy('start_date')->get()->map(function ($batch) {
                return [
                    'id' => $batch->id,
                    'name' => $batch->name,
                    'code' => $batch->code,
                    'start_date' => $batch->start_date,
                    'start_date_formatted' => $batch->start_date ? date('j M Y', $batch->start_date) : null,
                    'end_date' => $batch->end_date,
                    'end_date_formatted' => $batch->end_date ? date('j M Y', $batch->end_date) : null,
